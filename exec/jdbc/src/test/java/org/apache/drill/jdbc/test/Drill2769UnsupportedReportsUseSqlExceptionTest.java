  ...
  private static class NoNonSqlExceptionsChecker<INTF> {
    ...
    public void testMethods() {
      for ( Method method : jdbcIntf.getMethods() ) {
        ...
        if ( "close".equals( method.getName() ) ) {
        ...
        else if (false&& DatabaseMetaData.class == jdbcIntf
          ...
          // At least temporarily, skip other DatabaseMetaData methods that
          // issue queries and are slow (at least in debugging mode).
